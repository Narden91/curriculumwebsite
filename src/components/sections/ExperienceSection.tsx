      ...
      <div className="container">
        ...
        <div className="experience-timeline">
          {experienceData.map((exp, index) => (
            <div
              key={index}
              className={`experience-card ${index % 2 === 0 ? 'left' : 'right'} ${expandedCards.has(index) ? 'expanded' : 'collapsed'
                }`}
            >
                ...
                <div className="timeline-dot">
                  <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                      d="M20 7h-4V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v2H4a2 2 0 00-2 2v10a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2zM10 5h4v2h-4V5z"></path>
                  </svg>
                </div>
              </div>
