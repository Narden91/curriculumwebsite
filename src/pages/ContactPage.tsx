                ...
                <div className="container">
                    <div className="contact-intro">
                        ...
                        <p>
                            ...
                            or looking to discuss potential opportunities, I'd love to hear from you.
                        </p>
                    </div>
                    ...
                    <div className="contact-grid">
                        ...
                        <div className="contact-card">
                            ...
                            <h3>Phone</h3>
                            <p>Available for calls and meetings</p>
                            <a href="tel:+393270181459" className="contact-link">
                                (+39) 327-0181-459
                            </a>
                        </div>
